...
<div id="legend">
    ...
    <div style="font-size: 1.15em;">
        <b>Bogenabstand (F1 ↔ F2):</b> <span id="vehicles-dist">–</span>
    </div>
</div>
...
function renderAtIndex(index, animate) {
    ...
    if (latestServerPoints.Fahrzeug1 && latestServerPoints.Fahrzeug2) {
        const stationF1 = extraReferenceDistanceM(
            latestServerPoints.Fahrzeug1
        );
        const stationF2 = extraReferenceDistanceM(
            latestServerPoints.Fahrzeug2
        );
        const d = Math.abs(stationF2 - stationF1);
