...
function axisStationDistanceM(point, geometry) {
    ...
    for (let index = 0; index < stations.length - 1; index += 1) {
        ...
        // Interior segments are finite.  The first and last segments are
        // extended as rays so stationing can continue before Achse 0 and
        // beyond the last axis instead of being clamped at the endpoint.
        let fraction;
