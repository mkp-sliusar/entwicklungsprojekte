 ...
 *      Li-SOCl2 cells.
 *    - INA226 remains optional for diagnostics but is not included in this
 *      project's compact LoRa uplink.
 *    - AP mode provides captive-portal DNS. Automatic browser redirect is
 *      disabled by default and can be enabled in Expert mode.
 *    - Compact LoRa payload V5 contains only battery percentage/voltage,
 *      position, Wegsensor raw value, and temperature.
 *
...
String apSsid() {
  ...
  return String("MultiConnect-Leer-") + suffix;
}
...
// ================================ NVS ===============================
void loadConfig() {
  preferences.begin("multileer", true);
...
void saveConfig() {
  preferences.begin("multileer", false);
...
// ============================= Payload ==============================
// Payload V5, 12 bytes, big-endian:
// 0 version=5
// 1 battery percentage, uint8 (255 = null)
// 2..3 battery voltage mV, uint16 (65535 = null)
// 4..5 position x1000 mm, uint16 (65535 = null)
// 6..9 Wegsensor raw, int32 (INT32_MAX = null)
// 10..11 temperature x100, int16 (INT16_MAX = null)
...
static void prepareTxFrame(uint8_t port) {
  ...
  putInt32BE(index, cached.wegValid ? cached.wegRaw : INT32_MAX);
